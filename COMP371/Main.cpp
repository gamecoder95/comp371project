//Used to debug som eskybox issues
//https://www.opengl.org/discussion_boards/showthread.php/199075-OpenGL-and-CubeMaps-all-I-get-is-a-black-cube
...
//draw skybox
		...
		glUniform1i(glGetUniformLocation(skyboxShaderProgram, "skyboxTexture"), timeOfDay); //timeOfDay calls the texture number to use
